        ...
        while True:
            ...
            if snapshot.hl_timestamp > last_hl_ts:
                data_point = {
                    ...
                    "poly_bid_px_1": None, "poly_bid_sz_1": None,
                    "poly_ask_px_1": None, "poly_ask_sz_1": None,
                    "poly_bid_px_2": None, "poly_bid_sz_2": None,
                    "poly_ask_px_2": None, "poly_ask_sz_2": None,
                    "poly_bid_px_3": None, "poly_bid_sz_3": None,
                    "poly_ask_px_3": None, "poly_ask_sz_3": None,
                    "poly_bid_px_4": None, "poly_bid_sz_4": None,
                    "poly_ask_px_4": None, "poly_ask_sz_4": None,
                    "outcome": "perpetual",
                    "event_type": "L2_UPDATE",
                    "signed_flow_rate": snapshot.signed_flow_rate,
                    "strike_price": snapshot.strike_price,
                    "rotation_ts": snapshot.rotation_ts,
                    "timeframe_minutes": snapshot.timeframe_minutes,
                    "path_delta": snapshot.path_delta,
                    "path_curvature": snapshot.path_curvature,
                    "sigma_fast": snapshot.sigma_fast,
                    "p_approx": snapshot.p_approx,
                    "p_1_minus_p": snapshot.p_1_minus_p,
                    "phase_lag": snapshot.phase_lag,
                    "nu_regime": snapshot.nu_regime,
                    "pm_spread": snapshot.pm_spread,
                    "depth_sweep_cost_5pct": snapshot.depth_sweep_cost_5pct,
            ...
            if snapshot.poly_up_timestamp > last_poly_up_ts:
                data_point = {
                    ...
                    "poly_bid_px_1": snapshot.poly_up_bids[1].price, "poly_bid_sz_1": snapshot.poly_up_bids[1].size,
                    "poly_ask_px_1": snapshot.poly_up_asks[1].price, "poly_ask_sz_1": snapshot.poly_up_asks[1].size,
                    "poly_bid_px_2": snapshot.poly_up_bids[2].price, "poly_bid_sz_2": snapshot.poly_up_bids[2].size,
                    "poly_ask_px_2": snapshot.poly_up_asks[2].price, "poly_ask_sz_2": snapshot.poly_up_asks[2].size,
                    "poly_bid_px_3": snapshot.poly_up_bids[3].price, "poly_bid_sz_3": snapshot.poly_up_bids[3].size,
                    "poly_ask_px_3": snapshot.poly_up_asks[3].price, "poly_ask_sz_3": snapshot.poly_up_asks[3].size,
                    "poly_bid_px_4": snapshot.poly_up_bids[4].price, "poly_bid_sz_4": snapshot.poly_up_bids[4].size,
                    "poly_ask_px_4": snapshot.poly_up_asks[4].price, "poly_ask_sz_4": snapshot.poly_up_asks[4].size,
                    "outcome": "up",
            ...
            if snapshot.poly_down_timestamp > last_poly_down_ts:
                data_point = {
                    ...
                    "poly_bid_px_1": snapshot.poly_down_bids[1].price, "poly_bid_sz_1": snapshot.poly_down_bids[1].size,
                    "poly_ask_px_1": snapshot.poly_down_asks[1].price, "poly_ask_sz_1": snapshot.poly_down_asks[1].size,
                    "poly_bid_px_2": snapshot.poly_down_bids[2].price, "poly_bid_sz_2": snapshot.poly_down_bids[2].size,
                    "poly_ask_px_2": snapshot.poly_down_asks[2].price, "poly_ask_sz_2": snapshot.poly_down_asks[2].size,
                    "poly_bid_px_3": snapshot.poly_down_bids[3].price, "poly_bid_sz_3": snapshot.poly_down_bids[3].size,
                    "poly_ask_px_3": snapshot.poly_down_asks[3].price, "poly_ask_sz_3": snapshot.poly_down_asks[3].size,
                    "poly_bid_px_4": snapshot.poly_down_bids[4].price, "poly_bid_sz_4": snapshot.poly_down_bids[4].size,
                    "poly_ask_px_4": snapshot.poly_down_asks[4].price, "poly_ask_sz_4": snapshot.poly_down_asks[4].size,
                    "outcome": "down",
                    "event_type": "ORDER_BOOK",
                    "signed_flow_rate": snapshot.signed_flow_rate,
                    "strike_price": snapshot.strike_price,
            ...
            if time.time() - last_flush_time > 60 or len(buffer) >= 10000: # 60 Seconds or 10K items
                if buffer:
                    ...
                    schema = {
                        ...
                        "poly_bid_px_0": pl.Float64, "poly_bid_sz_0": pl.Float64,
                        "poly_ask_px_0": pl.Float64, "poly_ask_sz_0": pl.Float64,
                        "poly_bid_px_1": pl.Float64, "poly_bid_sz_1": pl.Float64,
                        "poly_ask_px_1": pl.Float64, "poly_ask_sz_1": pl.Float64,
                        "poly_bid_px_2": pl.Float64, "poly_bid_sz_2": pl.Float64,
                        "poly_ask_px_2": pl.Float64, "poly_ask_sz_2": pl.Float64,
                        "poly_bid_px_3": pl.Float64, "poly_bid_sz_3": pl.Float64,
                        "poly_ask_px_3": pl.Float64, "poly_ask_sz_3": pl.Float64,
                        "poly_bid_px_4": pl.Float64, "poly_bid_sz_4": pl.Float64,
                        "poly_ask_px_4": pl.Float64, "poly_ask_sz_4": pl.Float64,
                        "outcome": pl.String,
                        "event_type": pl.String,
                        "signed_flow_rate": pl.Float64,
                        "strike_price": pl.Float64,
                        "rotation_ts": pl.UInt64,
                        "timeframe_minutes": pl.UInt32,
                        "path_delta": pl.Float64,
                        "path_curvature": pl.Float64,
                        "sigma_fast": pl.Float64,
                        "p_approx": pl.Float64,
                        "p_1_minus_p": pl.Float64,
                        "phase_lag": pl.Float64,
                        "nu_regime": pl.Float64,
                        "pm_spread": pl.Float64,
                        "depth_sweep_cost_5pct": pl.Float64,
                        "stale_flag": pl.UInt32
                    }
