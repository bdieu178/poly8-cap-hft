...
impl L2BookStruct {
    pub fn copy_to_snapshot(&self) -> L2BookSnapshot {
        L2BookSnapshot {
            ...
            p_1_minus_p: self.p_1_minus_p,
            phase_lag: self.phase_lag,
            nu_regime: self.nu_regime,
            pm_spread: self.pm_spread,
            depth_sweep_cost_5pct: self.depth_sweep_cost_5pct,
            stale_flag: self.stale_flag,
            padding_gru: self.padding_gru,
        }
    }
}
...
mod tests {
    ...
    fn test_ring_buffer_layout() {
        assert_eq!(size_of::<SpscRingBufferRust<L2BookStruct>>(), 2621632);
        ...
        assert_eq!(offset_of!(SpscRingBufferRust<L2BookStruct>, dropped_count), 2621568);
    }

    #[test]
    fn test_struct_alignment() {
        assert_eq!(std::mem::size_of::<L2BookStruct>(), 1280);
    ...
    fn test_l2_book_offsets() {
        ...
        assert_eq!(offset_of!(L2BookStruct, path_delta), 1120);
    }
