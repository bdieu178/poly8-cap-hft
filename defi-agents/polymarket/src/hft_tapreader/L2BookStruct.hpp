...
struct L2BookStruct {
    ...
    // --- [1096-1119] Timeframe and Padding ---
    uint32_t timeframe_minutes;
    uint32_t padding_final_u32;

    // --- [1120-1199] Analytics / GRU Features ---
    double path_delta;
    ...
    double nu_regime;
    double pm_spread;
    double depth_sweep_cost_5pct;
    uint32_t stale_flag;
    uint32_t padding_gru;
    
    // --- [1200-1279] Padding to maintain 1280-byte target ---
    uint8_t padding_final[80];
    ...
    L2BookStruct(const L2BookStruct& other) {
        ...
        path_delta = other.path_delta;
        path_curvature = other.path_curvature;
        sigma_fast = other.sigma_fast;
        p_approx = other.p_approx;
        p_1_minus_p = other.p_1_minus_p;
        phase_lag = other.phase_lag;
        nu_regime = other.nu_regime;
        pm_spread = other.pm_spread;
        depth_sweep_cost_5pct = other.depth_sweep_cost_5pct;
        stale_flag = other.stale_flag;
        padding_gru = other.padding_gru;
...
static_assert(sizeof(L2BookStruct) == 1280, "L2BookStruct size mismatch. Alignment error.");
