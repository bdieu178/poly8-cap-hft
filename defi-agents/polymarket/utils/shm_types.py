...
class L2BookStruct(ctypes.Structure):
    _fields_ = [
        ...
        ("path_delta", ctypes.c_double),
        ("path_curvature", ctypes.c_double),
        ("sigma_fast", ctypes.c_double),
        ("p_approx", ctypes.c_double),
        ("p_1_minus_p", ctypes.c_double),
        ("phase_lag", ctypes.c_double),
        ("nu_regime", ctypes.c_double),
        ("pm_spread", ctypes.c_double),
        ("depth_sweep_cost_5pct", ctypes.c_double),
        ("stale_flag", ctypes.c_uint32),
        ("padding_gru", ctypes.c_uint32),
        ("padding_final", ctypes.c_uint8 * 80),
    ]
...
if __name__ == "__main__":
    ...
    assert ctypes.sizeof(L2BookStruct) == 1280
    ...
    assert ctypes.sizeof(SpscRingBufferStruct) == 2621632
